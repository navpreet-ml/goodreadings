...
def bookpage(isbn):
    ...
    if request.method=="POST" and secondreview==None:
        ...
        db.commit()
    if request.method=="POST" and secondreview!=None:
        warning="Sorry. You cannot add a second review."
    
    res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "ohwBiYWB3YzoD9q6uBmwLg", "isbns": isbn})
